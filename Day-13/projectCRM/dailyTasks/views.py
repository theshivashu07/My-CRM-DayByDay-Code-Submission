...
def calculatorEMIdirect20210605(request):
	return render(request,"dailyTasks/date-20210605/calculatorEMI.html")

#---------------------------------------------------------------------------------------
def calcEMI20210605(request):
	return render(request,"dailyTasks/date-20210605/calcEMI.html",{"loanEMI":0, "totalInterest":0 , "totalPay":0})

#---------------------------------------------------------------------------------------
def calcCovid20210605(request):
	if request.method=="POST":
		...
		if(('Nothing' in HealthIssues) or ('Nothing' in covidSymptoms)):
			...
			msg="No Risk";
		return render(request,"dailyTasks/date-20210605/calcCovid.html",{"msg":msg})
	return render(request,"dailyTasks/date-20210605/calcCovid.html")
