...
def assignment220210603(request):
	...
	return render(request,"dailyTasks/date-20210603/assignment2.html")
...
def assignment2020210603(request):
	if request.method=="POST":
		selection = request.POST["selection"]
		return render(request,"dailyTasks/date-20210603/assignment2.0.html",{'result':selection})
	selection="";
	return render(request,"dailyTasks/date-20210603/assignment2.0.html",{'result':selection})
...
def assignment320210603(request):
	if request.method=="POST":
		...
		return render(request,"dailyTasks/date-20210603/assignment3.html",{'data':lst,'val':k})
...
def assignment420210603(request):
	if request.method=="POST":
		...
		return render(request,"dailyTasks/date-20210603/assignment4.html",{'data':Cities,'CountryNamed':Country})
	Cities=["Nothing is there"];
...
def feedback20210603(request):
	if request.method=="POST":
		...
		for data in branches:
			branch=branch+data+" ";
		result = ["Hey " + name,"Your Gender is " + gender, "Your selected courses is " + cource,"and Branchs is "+ branch,"and feedback is " + feeds]
		return render(request,"dailyTasks/date-20210603/feedback.html",{"data":result,"txtbox1":request.POST["txtname"]})  
